...
export default function ToolBarEvent() {
  return (
    <>
      <div className="hidden lg:block relative top-[91px] overflow-hidden z-50">
        <div className="fixed top-0 left-0 bg-toolbarBlack w-full h-[56px] flex items-center justify-center">
          ...
          <h1 className="text-whiteTextBar text-[13px] font-sfPro leading-[15.51px] text-center font-bold">
            Mysterious Creatues
          </h1>
        </div>
      </div>
